...
<div className={`form-check form-switch text-${props.mode === 'light'? 'primary' : 'light'}`}>
  <input className="form-check-input mx-1" type="checkbox" onClick={props.toggleMode1} role="switch" id="flexSwitchCheckDefault"/>
...
<div className={`form-check form-switch text-${props.mode === 'light'? 'danger' : 'light'}`}>
  <input className="form-check-input mx-1" type="checkbox" onClick={props.toggleMode2} role="switch" id="flexSwitchCheckDefault"/>
